...
FONT_SIZE=72
pygame.init()
image=pygame.transform.scale(pygame.image.load(r"C:\Users\Public\python\lesson36\background.jpg"),(SCREEN_WIDTH,SCREEN_HEIGHT))
...
class sprite(pygame.sprite.Sprite):
    def __init__(self,color,height,width):
        ...
        pygame.draw.rect(self.image,pygame.Color(color),pygame.Rect(0,0,width,height))
